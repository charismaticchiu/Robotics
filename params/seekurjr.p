...
Subclass seekurjr        ; specific type of robot
RobotRadius 600          ; radius in mm
RobotDiagonal 600        ; half-height to diagonal of octagon
RobotWidth 830           ; width in mm
RobotLength 1200         ; length in mm of the whole robot
...
MaxRVelocity 80          ; absolute maximum degrees / sec
...
NumFrontBumpers 4        ; number of front bumpers on the robot
RearBumpers true         ; if the robot has a rear bump ring
NumRearBumpers 4         ; number of rear bumpers on the robot
...
LaserCumulativeBufferSize 0 ; Cumulative buffer size to use for the laser, 0 to
                         ; use default
LaserX 527               ; x location of laser, mm
...
LaserStartDegrees -117   ; start degrees for the sensor (leave blank for
                         ; default, use this to constrain the range) (double)
LaserEndDegrees 117      ; start degrees for the sensor (leave blank for
                         ; default, use this to constrain the range) (double)
...
LaserType lms1XX         ; type of laser
LaserPortType tcp        ; type of port the laser is on
LaserPort 192.168.0.2    ; port the laser is on
LaserAutoConnect false   ; if the laser connector should autoconnect this laser
                         ; or not
LaserFlipped false       ; if the laser is upside-down or not
LaserPowerControlled false ; if the power to the laser is controlled by serial
