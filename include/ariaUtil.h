...
public:
  ...
  */
	...
	ArPose & operator+= ( const ArPose & other)
  {
    myX += other.myX;
    myY += other.myY;
    ArMath::fixAngle(myTh + other.myTh);
    return *this;
  }
...
/// Note this class will may later be wrapped in with the above, but since
/// this is just a base release that wasn't done here (I don't think
/// anyone would be using this class or the above directly)
class ArLaserCreatorHelperLMS1XX
{
public:
  /// Creates an ArLMS1xx
